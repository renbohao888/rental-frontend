  ...
  <div class="page-container" v-loading="loading">
    ...
    <el-row :gutter="20" style="margin-bottom: 20px;">
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card"><div class="stat-label">平台总用户</div><div class="stat-value">{{ stats.userStats?.totalUsers || 0 }}</div></el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card"><div class="stat-label">房源总数</div><div class="stat-value">{{ stats.roomStats?.totalRooms || 0 }}</div></el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card"><div class="stat-label">订单总数</div><div class="stat-value">{{ stats.orderStats?.totalOrders || 0 }}</div></el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="stat-card money"><div class="stat-label">平台总收益</div><div class="stat-value">¥{{ stats.revenueStats?.totalRevenue || 0 }}</div></el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :md="14">
        <el-card>
          ...
          <el-table :data="stats.recentTrend || []" size="small" border stripe>
      ...
      <el-col :xs="24" :md="10">
        <el-card>
          ...
          <div v-for="(r, i) in stats.hotRooms || []" :key="i" class="hot-item">
